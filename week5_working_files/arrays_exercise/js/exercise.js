 ...
 */
 ...
 // Get all images that are equal to index 0 and change the source to q2
$("img").eq(0).attr("src, q2");


 // Get all images that are equal to index -1 (counting backwards) and change the source to q2
